...
4. Produce detailed artifacts that are implementation-ready for UI/UX, backend, and database agents, not just high-level requirement notes.
4. Fill only the business detail that is applicable to each Feature and Story.
5. Write only the required BA artifacts and keep each artifact.
...
- `personas.md`: Document business personas with goals, responsibilities, pain points, permissions/visibility expectations, and link them to screens and processes without technical architecture.
